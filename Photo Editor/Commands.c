...
unsigned char **
LOAD (const char *file_name, int *width, int *height, int *x1, int *y1,
      int *x2, int *y2, int *color_image, int *my_image_max, char *type)
{
      ...
      if (second_character == 'G')
        {
          ...
          // Read the image
          unsigned char **pixels = NULL;
          pixels = (unsigned char **)malloc (my_height
                                             * sizeof (unsigned char *));
          for (int i = 0; i < my_height; i++)
            pixels[i]
                = (unsigned char *)malloc (my_width * sizeof (unsigned char));
      ...
      // Binary RGB
      else if (second_character == 'R')
        {
          ...
          pixels = (unsigned char **)malloc (my_height
                                             * sizeof (unsigned char *));
          for (int i = 0; i < my_height; i++)
            pixels[i] = (unsigned char *)malloc (3 * my_width
                                                 * sizeof (unsigned char));
...
void
SELECT (int *x1, int *y1, int *x2, int *y2, int width, int height,
...
void
SELECT_ALL (int *width, int *height, int *x1, int *y1, int *x2, int *y2,
...
// certain angle.
void
ROTATE (int angle, unsigned char ***image, int *x1, int *y1, int *x2, int *y2,
...
void
CROP (int *x1, int *y1, int *x2, int *y2, int *width, int *height,
...
void
GRAYSCALE (int *x1, int *y1, int *x2, int *y2, unsigned char ***image)
{
...
int
minimum_value (int first_value, int second_value)
{
...
void
SEPIA (int *x1, int *y1, int *x2, int *y2, unsigned char ***image,
...
void
SAVE (const char *file_name, unsigned char **image, int width,
...
void
EXIT (unsigned char ***image, const int height)
{
...
void
check_command (int command_value, int *width, int *height, int *image_status,
               int *x1, int *y1, int *x2, int *y2, unsigned char ***image,
               char **input, int *color_image, char *type, int *my_image_max,
               int *whole_map_selected, int *correct, int *cropped,
