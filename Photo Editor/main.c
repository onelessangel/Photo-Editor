...
int main(void) {
    ...
    int color_image=0, whole_map_selected=1;
    char type = '0';
    ...
    while(UP) {
        ...
        check_command(command_value, &width, &height, &image_status,&x1,&y1,&x2,&y2,&image,&input,&color_image,&type,&my_image_max,&whole_map_selected);
    }
