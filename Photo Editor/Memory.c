...
int
find_command_value (const char *commands[], char *input)
{
...
unsigned char **
copy_pixels_selection (const int x1, const int y1, const int x2, const int y2,
                       unsigned char ***image)
{
...
void
free_pixels (const int my_image_height, unsigned char ***pixel_matrix)
{
